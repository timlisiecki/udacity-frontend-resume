...
var HTMLlinkedin = '<li class="flex-item"><span class="green-text">linkedin</span><span class="white-text">%data%</span></li>';
var HTMLwebsite = '<li class="flex-item"><span class="green-text">website</span><span class="white-text">%data%</span></li>';
...
var HTMLskillsStart = '<div><h3 id="skills-h3">Top Skills:</h3><ul id="skills" class="flex-column"></ul>';
var HTMLskills = '<li class="flex-item"><span class="white-text">%data%</span></li></div>';

var HTMLworkStart = '<div class="work-entry"></div>';
var HTMLworkTitle = '<h3>%data%';
var HTMLworkEmployer = ' - %data%</h3>';
var HTMLworkDates = '<div class="date-text">%data%</div>';
var HTMLworkLocation = '<div class="location-text">%data%</div>';
var HTMLworkDescription = '<p><br>%data%</p>';

var HTMLprojectStart = '<div class="project-entry"></div>';
var HTMLprojectTitle = '<a href="%urldata%" target="_blank">%data%</a>';
